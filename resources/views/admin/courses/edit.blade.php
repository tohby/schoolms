                        ...
                        <div class="col-lg-8 col-sm-12">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" aria-describedby="name" value="{{ $course->name }}" required>
                                @error('name')
                        ...
                        <div class="col-lg-8 col-sm-12">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror"
                                    name="code" aria-describedby="code" value="{{ $course->code }}" required>
                                @error('code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-lg-8 col-sm-12">
                            <div class="mb-4">
                                ...
                                <textarea rows="3" class="form-control @error('description') is-invalid @enderror" name="description"
                                    aria-describedby="name" required>{{ $course->description }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
