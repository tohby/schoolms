                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                            ...
                            <li class="breadcrumb-item text-capitalize active" aria-current="page">
                                {{ Str::plural($userType) }}</li>
                        </ol>
                    </nav>
                    <h2 class="h4">All {{ Str::of($userType)->title()->plural() }}</h2>
                </div>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="/admin/users/create?type={{ $userType }}"
                        ...
                        Add {{ Str::of($userType)->title()->singular() }}
                    </a>
                </div>
            </div>
            <div class="table-settings mb-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col col-md-6 col-lg-3 col-xl-4">
                        <form id="users-search-form" action="{{ action('SearchController@users') }}" method="POST">
                            @csrf
            ...
            <div class="col-12 px-0 mb-4">
                <div class="card border-0 shadow">
                        ...
                        @foreach ($users as $user)
                            <div
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    {{-- <a href="doctors/{{ $user->id }}/edit" class=" align-items-center fw-bold mr-3">
                                        Edit
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <div
                        ...
                        {{ $users->links() }}
                        <div class="fw-normal small mt-4 mt-lg-0">Showing <b>{{ $users->count() }}</b> out of
                            <b>{{ $totalCount }}</b>
                            entries
                        </div>
                    </div>
